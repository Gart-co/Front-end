...
// )
// }
  function closePanel(msg, para){
    setShowPanel(false)
  }
  useEffect(() =>{
    PubSub.subscribe('close', closePanel)
  })
  return(
    ...
    {console.log("connectWallet",connectWallet)}
      ...
      <button onClick={() =>handleButtonClick()}>
        <div className="vertically-center connect-wallet" onClick={() =>handleButtonClick()}>
            <p onClick={() =>handleButtonClick()} className="connect-wallet-text">Connect Wallet</p>
        </div>
      </button>
    </div>
    
    {showPanel? <div className="Frame1677" style={{position: 'absolute', width: 531, height: 568, top:128, right: 24,  background: 'white', borderRadius: 16, border: '4px black solid'}}>
{/* <div className="Frame1676" onClick={() => handleButtonClick()} style={{position: 'absolute', top:24, right:24, padding: 8, background: '#22252D', borderRadius: 48, justifyContent: 'center', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
    <button className="Close" onClick={() => handleButtonClick()} style={{width: 24, height: 24, padding: 6, justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
        <img onClick={() => handleButtonClick()} src='./shutdown.svg'/>
    </button>
</div> */}
<div className="Group1000004744" style={{height: '100%', width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent:'center', position: 'relative'}}>
  <div style={{width: 377, height:372, display:'flex', flexDirection: 'column', alignItems: 'center', justifyContent:'center'}}>
    ...
    <div className="Wallet" style={{width: 377, height: 138, left: 0, top: 0, position: 'relative', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 12, display: 'inline-flex'}}>
        <button className="ConnectWalletButton" style={{width:377, height: 64, alignSelf: 'stretch', padding: 16, background: '#E45F35', borderRadius: 12, justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
            <div className="IconText" style={{justifyContent: 'flex-start', alignItems: 'center', gap: 16, display: 'flex'}}>
                ...
                <div onClick={connectWallet} className="Primary" style={{textAlign: 'center', color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '700',  wordWrap: 'break-word'}}>Metamask</div>
            </div>
